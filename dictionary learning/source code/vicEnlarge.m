...
% enlarge the dictionary using imresize (smoother one)
% For S1, keep the non-zero values and replace zeros with new generated
% sparse numbers
% For Z1, the same as the original code
