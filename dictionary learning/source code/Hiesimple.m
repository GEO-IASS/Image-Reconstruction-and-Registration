% Use the vicResize to enlarge the dictionary and change the corresponding
% patch skip.
%
% vicResize can be replaced by vicEnlarge which changes the S and Z so
% patch skip can be kept unchanged.
%
...
for i = 1:5
    ...
    imgRecon = patches2video_fast(Xrecon, N1,N2,N3, d1,d1);
